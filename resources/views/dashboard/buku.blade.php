        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            @include('partial.topbar')
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <a href="/dashboard/buku/form" class="btn btn-sm btn-primary mb-3">Tambah Buku</a>
                        <table id="table_id" class="display">
                            ...
                            <tbody>
                                ...
                                <td class="text-nowrap">
                                    ...
                                    <a href="/dashboard/buku/form/{{$buku['id_buku']}}" class="btn btn-warning btn-sm">Update</a>
                                </td>
                                </tr>
                                <?php } ?>
