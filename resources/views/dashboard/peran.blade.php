        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <a href="/dashboard/peran/form" class="btn btn-sm btn-primary mb-3">Tambah peran</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <a href="/dashboard/peran/hapus/{{ $peran->id_peran }}"
                                                class="btn btn-danger btn-sm">Hapus</a>
                                            <a href="/dashboard/peran/form/{{ $peran->id_peran }}"
